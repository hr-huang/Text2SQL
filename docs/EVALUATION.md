...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| DeepSeek V4 Flash | v7 | **90.0%** | 54 / 60 | 28 / 29 | 23 / 27 | 3 / 4 | 40.6s | 706,869 |

Why this matters:

- Simple questions are nearly solved: 96.6%.
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `deepseek_v4_flash.json` | v7 | **90.0%** | 96.6% | 85.2% | 75.0% | 40.6s |
...
## What Changed From v1 to v7

| Area | v1 behavior | v7 behavior | Effect |
| --- | --- | --- | --- |
...
python scripts/run_evaluation.py --preset deepseek_v4_flash --tag v7
